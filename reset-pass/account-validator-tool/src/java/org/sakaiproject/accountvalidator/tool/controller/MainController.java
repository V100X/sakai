...
public class MainController {
    ...
    public String reqAccIndex(Model model, HttpServletRequest request, HttpServletResponse response, 
            @RequestParam(value="tokenId", required = false) String tokenId) {
                   
        userLocale = localeResolver(request, response);

        model.addAttribute("uiService", serverConfigurationService.getString("ui.service", "Sakai"));
        
        // va = getValidationAccount(tokenId, model);
        ...
        va = validationLogic.getVaLidationAcountBytoken(tokenId);
        ...
        boolean passwordPolicyEnabled = true;//userDirectoryService.getPasswordPolicy() != null;
        ...
        model.addAttribute("passwordPolicyEnabled", passwordPolicyEnabledJavaScript);
            ...
            if (!"".equals(serverConfigurationService.getString("account-validator.terms"))) {
                ...
                String termsText = serverConfigurationService.getString("account-validator.terms");
    ...
    public @ResponseBody
    String reqAccForm(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
        ...
        if (va == null) {
            ...
            return validateAccount(va).toJSONString();
        }       
    }
    ...
    public String passResIndex(Model model, HttpServletRequest request, HttpServletResponse response, 
            @RequestParam(value="tokenId", required = false) String tokenId) {

        userLocale = localeResolver(request, response);
         
        model.addAttribute("uiService", serverConfigurationService.getString("ui.service", "Sakai"));
        int resetMinutes = serverConfigurationService.getInt(MAX_PASSWORD_RESET_MINUTES, MAX_PASSWORD_RESET_MINUTES_DEFAULT);
        String expirationTime = getFormattedMinutes(resetMinutes);
        ...
        // } checks left:    
            ...
            model.addAttribute("warnMsg", messageSource.getMessage("msg.alreadyValidated", null, userLocale));
            model.addAttribute("requestPass", addResetPassLink(model, va));
    ...
    public @ResponseBody
    String passResForm(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
         @RequestParam(value="tokenId", required = false) String tokenId) throws JsonProcessingException { 
    ...
    public String newUserIndex(Model model, HttpServletRequest request, HttpServletResponse response, 
        ...
        if(va.getAccountStatus().equals(ValidationAccount.ACCOUNT_STATUS_USERID_UPDATE)) {
            ...
            while (git.hasNext()) {
                ...
                if (!existingSites.contains(groupId)) {
                    ...
                    try {
                        ...
                        model.addAttribute("siteListItem", s.getTitle());
            ...
            if (existingSites.size() >= 2)  {
                model.addAttribute("welcome", messageSource.getMessage("validate.welcome.plural", new String[]{uiService}, userLocale));

            } else {
                model.addAttribute("welcome", messageSource.getMessage("validate.welcome.single", new String[]{uiService}, userLocale));
            }
        }
    ...
    public @ResponseBody
    String newUserForm(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
         @RequestParam(value="tokenId", required = false) String tokenId) throws JsonProcessingException { 
    ...
    public String traMembIndex(Model model, HttpServletRequest request, HttpServletResponse response, 
            @RequestParam(value="tokenId", required = false) String tokenId) {
        ...
        return "transferMemberships";
    } 


    @RequestMapping(value = {"/transferMemberships"}, method = RequestMethod.POST, produces="application/json")
    public @ResponseBody
    String traMembForm(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
    @RequestParam(value="tokenId", required = false) String tokenId) throws JsonProcessingException { 
        ...
        if (va == null) {
            ...
            return claimAccount(vc).toJSONString();    
        }
    }
    ...
    public String validIndex(Model model, HttpServletRequest request, HttpServletResponse response, 
            @RequestParam(value="tokenId", required = false) String tokenId) {
    ...
    public @ResponseBody
    String validForm1(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
        @RequestParam(value="tokenId", required = false) String tokenId) throws JsonProcessingException { 
    ...
    public @ResponseBody
    String validForm2(HttpServletRequest req, HttpServletResponse response, Model model, @RequestBody String requestForm,
    @RequestParam(value="tokenId", required = false) String tokenId) throws JsonProcessingException { 
    ...
    public JSONObject validateAccount(ValidationAccount va) {
    ...
    public JSONObject claimAccount(ValidationClaim vc) {
    ...
    protected String addResetPassLink(Model model, ValidationAccount va) {
...
/*
    public void redirectToLegacyLink(Model model, ValidationAccount va) {
        ...
        String statusMessage = messageSource.getMessage("msg.acceptInvitation", args, userLocale);

        if (accountStatus != null) {
            
            if (accountStatus.equals(ValidationAccount.ACCOUNT_STATUS_PASSWORD_RESET)) {
                statusMessage = messageSource.getMessage("msg.resetPassword", args, userLocale);
            }
        }
        //build the href
        String url = getViewURL("validate", va);

        //model.addAttribute("redirectLink", statusMessage, url);

        String redirectMsg = "<a href="+url+">" +statusMessage+ "</a>";
        model.addAttribute("redirectLink", redirectMsg);
    }
